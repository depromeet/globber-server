...
public enum TravelType {
    ...
    public static TravelType determineType(TravelLevel level, Map<PhotoTag, Long> photoTagCounts) {
        ...
        double peopleRatio =
            (photoTagCounts.getOrDefault(PhotoTag.PEOPLE, 0L) * 100.0) / totalPhotos;
        double sceneryRatio =
            (photoTagCounts.getOrDefault(PhotoTag.SCENERY, 0L) * 100.0) / totalPhotos;
