...
//    @GetMapping("/{memberId}/link")
//    @Operation(summary = "멤버 여행 기록 링크 생성", description = "특정 멤버의 여행 기록 링크를 생성합니다.")
//    public ResponseEntity<String> generateTravelRecordLink(@PathVariable final Long memberId) {
//      String link = memberTravelService.generateTravelRecordLink(memberId);
