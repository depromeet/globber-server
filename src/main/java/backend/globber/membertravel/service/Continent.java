...
public enum Continent {
    ASIA("아시아", List.of(
            ...
            "TJK", "THA", "TLS", "TUR", "TKM", "ARE", "UZB", "VNM", "YEM", "CCK", "CXR", "IOT"
    )),
    EUROPE("유럽", List.of(
            ...
            "ESP", "SWE", "CHE", "UKR", "GBR", "VAT", "SJM", "XKX", "ALA"
    )),
    NORTH_AMERICA("북미", List.of(
            ...
            "TTO", "TCA", "USA", "VIR", "PRI", "GUF", "GRL", "BLM", "MAF", "BES", "SXM"
    )),
    ...
    OCEANIA("오세아니아", List.of(
            ...
            "MNP", "PLW", "PNG", "WSM", "SLB", "TKL", "TON", "TUV", "VUT", "WLF", "PCN"
    )),
    AFRICA("아프리카", List.of(
            ...
            "STP", "SEN", "SYC", "SLE", "SOM", "ZAF", "SSD", "SDN", "TZA", "TGO", "TUN", "UGA", "ZMB", "ZWE", "SHN"
    )),
